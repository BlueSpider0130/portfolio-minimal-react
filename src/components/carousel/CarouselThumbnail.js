...
const CAROUSELS = [
  {
    ...
    description: 'faker.lorem.paragraphs()',
    image: '/static/members/Xan.jpg'
  },
  {
    title: 'AR & VR',
    description: 'faker.lorem.paragraphs()',
    image: '/static/members/Allan.jpg'
  },
  {
    title: 'Engineering',
    description: 'faker.lorem.paragraphs()',
    image: '/static/members/Alexis.jpg'
  },
  {
    title: 'Manufacturing',
    description: 'faker.lorem.paragraphs()',
    image: '/static/members/Nicholas.jpg'
  },
  {
    title: 'Recruitment & Team management',
    description: 'faker.lorem.paragraphs()',
    image: '/static/members/Marcus.jpg'
  },
  {
    title: 'Recruitment & Team management',
    description: 'faker.lorem.paragraphs()',
    image: '/static/members/Rishabh.jpg'
  }
];
    ...
    <RootStyle>
      ...
      <Box
        sx={{
          ...
          ...(CAROUSELS.length === 5 && { maxWidth: THUMB_SIZE * 3 + 48 }),
          ...(CAROUSELS.length === 6 && { maxWidth: THUMB_SIZE * 6 }),
          '& .slick-current img': {
            opacity: 1,
